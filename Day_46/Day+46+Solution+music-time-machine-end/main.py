...
sp = spotipy.Spotify(
    auth_manager=SpotifyOAuth(
        ...
        redirect_uri="",
        client_id="",  # Replace with your actual Spotify client ID
        client_secret="",  # Replace with your actual Spotify client secret
        show_dialog=True,
...
song_uris = []
year = date.split("-")[0]  # Extract the year from the input date
